...
var CompareContacts, Contact, NotificationHelper, PICTUREREL, access_token, addContactPicture, addContactToCozy, async, createContact, https, im, listContacts, localizationManager, log, notification, numberProcessed, realtimer, total, url, _;
...
module.exports = function(token, callback) {
  ...
  return async.parallel({
    ...
    return async.eachSeries(contacts.google, function(gContact, cb) {
      return addContactToCozy(gContact, contacts.cozy, function(err) {
        return cb(err);
      });
    }, function(err) {
      if (err) {
