...
var Contact, NotificationHelper, PICTUREREL, access_token, addContactPicture, async, createContact, https, im, listContacts, log, notification, numberProcessed, realtimer, total, url, _;
...
module.exports = function(token, callback) {
  ...
  return listContacts(function(err, contacts) {
    ...
    return async.eachSeries(contacts, createContact, function(err) {
      if (err) {
        callback(err);
      }
      console.log("create notification for contacts");
      return notification.createOrUpdatePersistent("leave-google-contacts", {
        app: 'leave-google',
